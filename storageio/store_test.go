...
// 		store.AddHistory()
// 		frame.Interval++
// 		t.Log("new interval after update", frame.Interval, interval)
// 	}

// 	if !store.HasHistory(title) {
// 		t.Fatal("can't undo")
// 	}

// 	for store.HasHistory(title) {
// 		frame, err = store.Undo(title)
// 		if err != nil {
// 			t.Fatalf(err.Error())
// 		}
// 		t.Log("new interval after undo", frame.Interval, interval)
// 	}
